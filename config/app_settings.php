...
return [
    'definitions' => [
        ...
        'referral_bonus_enabled' => [
            ...
            'label' => 'Refer & Earn',
            'type' => 'toggle',
            'description' => 'Reward referrers when a referred user spends above the purchase threshold.',
            'default' => '1',
        ],
        'referral_bonus_amount' => [
            ...
            'type' => 'number',
            'description' => 'Wallet credit given to the referrer after the referred user crosses the purchase threshold.',
            'default' => '100',
        ],
        'referral_purchase_threshold' => [
            'group' => 'referrals',
            'label' => 'Referral Purchase Threshold (₹)',
            'type' => 'number',
            'description' => 'Minimum total purchases by the referred user before the referrer receives the bonus.',
            'default' => '2000',
        ],
    ],
];
